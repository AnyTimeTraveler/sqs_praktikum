...
public class Tests {
    ...
    public void own_equilateralTest() {
        ...
        assertEquals(TriangleType.EQUILATERAL_TRIANGLE, TriangleCheckerOwn.checkTriangle(2147483647, 2147483647, 2147483647));
    }
    ...
    public void own_isocleseTestOwn() {
        ...
        assertEquals(TriangleType.ISOSCELES_TRIANGLE, TriangleCheckerOwn.checkTriangle(4, 4, 3));
    }
    ...
    @Test //
    public void paper4Tests_noTriangle() {
        assertEquals(TriangleType.NO_TRIANGLE, TriangleCheckerOwn.checkTriangle(3, 5, 9));
    }
    @Test
    public void paper4Tests_equilateralTriangle() {
        assertEquals(TriangleType.EQUILATERAL_TRIANGLE, TriangleCheckerOwn.checkTriangle(8, 8, 8));
    }
    @Test
    public void paper4Tests_isocleseTriangle() {
        assertEquals(TriangleType.ISOSCELES_TRIANGLE, TriangleCheckerOwn.checkTriangle(8, 8, 9));
    }
    @Test
    public void paper4Tests_scaleneTriangle() {
        assertEquals(TriangleType.SCALENE_TRIANGLE, TriangleCheckerOwn.checkTriangle(3, 5, 7));
    }
}
