...
public class Tests {
    ...
    public void own_scaleneTestOwn() {
        ...
        assertEquals(TriangleType.SCALENE_TRIANGLE, TriangleCheckerOwn.checkTriangle(2147483640, 8, 2147483647));
    }
    ...
    @Test //gleichseitig
    public void streek_equilateralTest() {
    ...
    public void streek_scaleneTest() {
        ...
        assertEquals(TriangleType.SCALENE_TRIANGLE, TriangleChecker.checkTriangle(2147483640, 8, 2147483647));
    }
